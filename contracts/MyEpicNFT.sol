...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string[] firstWords = ["Ginger", "Tabby", "Striped", "Tortoiseshell", "Sphynx", "Colorpoint"];
  string[] secondWords =  ["Salmon", "Pizza", "Chicken", "Catnip", "Bagel", "Meatball"];
  string[] thirdWords = ["Whiskers", "Socks", "Paws", "Fluffball", "Princess", "Menace"];
